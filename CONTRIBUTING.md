...
some other ruleset that depends on rules_aptprep, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_aptprep=$(pwd)/rules_aptprep"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_aptprep` on your system will point to this folder.
...
https://github.com/nickguletskii/rules_aptprep/actions/workflows/tag.yaml
