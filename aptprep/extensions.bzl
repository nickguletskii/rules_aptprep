...
_sysroot_tag = tag_class(attrs = {
    ...
    "archive_extractor": attr.string(default = "auto", values = ["auto", "bazel", "tar"], doc = "Archive extractor: auto selects Bazel on Darwin and tar elsewhere. May be overridden globally with --repo_env=APTPREP_ARCHIVE_EXTRACTOR=..."),
    ...
    for module in module_ctx.modules:
        ...
        for tag in module.tags.sysroot:
            ...
            kwargs = {
                ...
                "archive_extractor": tag.archive_extractor,
